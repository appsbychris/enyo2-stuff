...
enyo.kind({
	...
	*/
	...
	menuToolsLeft: [
		{kind: "Image", name: "itemIcon", classes: "no-limits slideable-menu-icon"},
...
enyo.kind({
	...
	*/
	previous: {
		...
		icon: "assets/previousmenuicon.png",
		iconAlign: "left"
	},
	components: [
...
enyo.kind({
	name: "App",
	components: [
		{kind: "Button", content: "top", ontap: "openMenu"},
		{kind: "Button", content: "bottom", ontap: "openMenu"},
		{kind: "Button", content: "left", ontap: "openMenu"},
		{kind: "Button", content: "right", ontap: "openMenu"},
		{kind: "Button", content: "scrim", ontap: "openMenu"},
		{kind: "Button", content: "dynamic", ontap: "openMenu"},
		{name: "selectedItem", content: "Selected Item: None"},
		{style: "width:400px;height:400px;border: 1px solid black;", content: "tap in me", ontap: "openTap"},
		{name: "slideright",kind: "SlideableMenu", menuTitle: "Right Menu", onSelect: "showResult", components:[
			{content: "test1"},
			{content: "test2"},
			{content: "I have a sub menu", subMenu: true, classes: "green", subMenuItems: [
				{content: "SubMenu Test 1"},
				{content: "SubMenu Test 2"},
				{content: "SubMenu Test 3"},
				{content: "I have a sub menu", subMenu: true, classes: "red", subMenuItems: [
					{content: "SubMenu Test 1"},
					{content: "SubMenu Test 2"},
					{content: "SubMenu Test 3"}
				]},
				{content: "SubMenu Test 5"}

			]},
			{content: "test4"},
			{content: "test5"}
		]},
		{name: "slideleft",kind: "SlideableMenu", menuTitle: "Left Menu", align: "left", onSelect: "showResult", components:[
			{content: "test1"},
			{content: "test2"},
			{content: "I have a sub menu", subMenu: true, classes: "green", subMenuItems: [
				{content: "SubMenu Test 1"},
		...
		{name: "slidetop",kind: "SlideableMenu", menuTitle: "Top Menu", onSelect: "showResult", align: "top", components:[
			{content: "test1"},
			{content: "test2"},
			{content: "I have a sub menu", subMenu: true, classes: "green", subMenuItems: [
				{content: "SubMenu Test 1"},
		...
		{name: "slidebottom",kind: "SlideableMenu", menuTitle: "Bottom Menu", onSelect: "showResult",align: "bottom", components:[
			{content: "test1"},
			{content: "test2"},
			{content: "I have a sub menu", subMenu: true, classes: "green", subMenuItems: [
				{content: "SubMenu Test 1"},
		...
		{name: "slidescrim",kind: "SlideableMenu", menuTitle: "Scrim Menu", scrim: true, onSelect: "showResult",align: "top", left:100, components:[
			{content: "Scrim test1"},
			{content: "Scrim test2"},
			{content: "I have a sub menu", subMenu: true, classes: "green", subMenuItems: [
				{content: "SubMenu Test 1"},
		...
		{name: "slidedynamic",kind: "SlideableMenu", menuTitle: "Dynamic Menu", scrim: true, onSelect: "showResult",align: "bottom", left:75, components:[
			
		]},
		{name: "slidetap",kind: "SlideableMenu", menuTitle: "tap Menu", onSelect: "showResult",align: "bottom",modal: true, anchor: false,onFinishClose: "allowAnother", components:[
			{content: "test1"},
			{content: "test2"},
			{content: "I have a sub menu", subMenu: true, classes: "green", subMenuItems: [
				{content: "SubMenu Test 1"},
    ...
    openMenu: function(iS, iE) {
    	if (iS.content != "dynamic") {
        	this.$["slide" + iS.content].open();
        }
        else {
        	var n = enyo.irand(6) + 2;
        	var menu = [];
        	var s = 0;
        	for (var i = 0; i < n; i++) {
        		menu.push({
        			content: "Dynamic Menu " + i
        		});
        		if (enyo.irand(100) > 75) {
        			menu[menu.length-1].content = "Dynamic Sub Menu";
        			menu[menu.length-1].classes = "green";
        			s = enyo.irand(5) + 2;
        			menu[menu.length-1].subMenu = true;
        			menu[menu.length-1].subMenuItems = [];
        			for (var j = 0; j < s; j++) {
        				menu[menu.length-1].subMenuItems.push({content: "Dynamic SubMenu " + j});
        			}
        		}
        	}
        	this.$.slidedynamic.destroyClientControls();
        	this.$.slidedynamic.createComponents(menu);
        	this.$.slidedynamic.render();
        	this.$.slidedynamic.open();
        }
    },
    allowAnother: function() {
    	this.allow = true;
    },
    allow: true,
    openTap: function(iS, iE) {
		...
		var i = enyo.irand(4);
		this.$.slidetap.setAlign(a[i]);
		this.$.slidetap.open({top: iE.pageY, left: iE.pageX});
    },
    showResult: function(iS, iE) {
    	this.$.selectedItem.setContent("Selected Item: " + (iS.anchor === true ? "Anchored" : "un-Anchored") + " " + iS.menuTitle + " " + iE.content);
    }
});
