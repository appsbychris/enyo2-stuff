...
enyo.path.addPaths({layout: "C://Users/Thrice/Documents/GitHub/enyo2-stuff/ExpandableMenuDemo/enyo/tools/../../lib/layout/", onyx: "C://Users/Thrice/Documents/GitHub/enyo2-stuff/ExpandableMenuDemo/enyo/tools/../../lib/onyx/", onyx: "C://Users/Thrice/Documents/GitHub/enyo2-stuff/ExpandableMenuDemo/enyo/tools/../../lib/onyx/source/", onyx: "C://Users/Thrice/Documents/GitHub/enyo2-stuff/ExpandableMenuDemo/enyo/tools/../../lib/onyx/source/"});
...
var a = this.orient == "v", b = a ? "height" : "width", c = a ? "top" : "left";
this.applyStyle(b, null);
var d = this.getClientControls(), e = d.length < 2 ? 10 : (d.length - 1) * 10, f = this.hasNode()[a ? "scrollHeight" : "scrollWidth"] + e, g = this.$.contain.hasNode(), h = 0;
g && (h = 10 + (a ? g.scrollHeight : g.scrollWidth)), this.noAnimate === !1 ? this.$.animator.play({
startValue: this.open ? 0 + (g ? h : 0) : f,
endValue: this.open ? f : 0 + (g ? h : 0),
dimension: b,
position: c
}) : (this.applyStyle(b, this.open ? 0 + (g ? h : 0) : f + (g ? h : 0)), this.$.client.setShowing(this.open));
} else this.$.client.setShowing(this.open);
...
itemHeight: 46,
openAt: function(a) {
this.openCords = a, this.loadMenuItems(), this.$.mainMenu.requestMenuShow();
},
scrollMenu: function(a, b) {
console.log(), setTimeout(enyo.bind(this, function() {
this.$.mainMenuItems.scrollToControl(b.sender, !0);
}), 200);
},
...
e > window.innerHeight - 100 && (e = window.innerHeight - 100);
var f = "";
for (var g in this.openCords) g == "bottom" && (this.openCords[g] < 0 || window.innerHeight < e + this.openCords[g]) && (this.openCords[g] = window.innerHeight - e), g == "left" && (this.openCords[g] < 0 || window.innerWidth < 320 + this.openCords[g]) && (this.openCords[g] = window.innerWidth - 320), g == "top" && this.openCords[g] + e > window.innerHeight && (this.openCords[g] = window.innerHeight - e - 64), f = f + g + ":" + this.openCords[g] + "px !important;";
this.openLocation = f;
var h = "height: " + e + "px;";
this.openLocation.indexOf("left:") < 0 && (h += "left:auto;"), this.openLocation.indexOf("top:") < 0 && (h += "top:auto;"), this.openLocation.indexOf("bottom:") < 0 && (h += "bottom:auto;"), this.$.mainMenu.setStyle(h + this.openLocation), this.$.mainMenuItems.destroyClientControls(), this.$.mainMenuItems.createComponents(a, {
owner: this.$.mainMenu
}), this.$.mainMenuItems.setStyle("height: " + e + "px;"), this.$.mainMenu.render();
},
